...
requirements = c("nlme", "effects", "pastecs", "lattice", 
                 "psych", "ggplot2", "GGally", "mice", "VIM", "aod", "BaM", "lme4", "ipw", "gridExtra")
...
<<<<<<< HEAD
Scatterplot wiht interaction and calories:
...
>>>>>>> b5a8fe6738a72c08aa25e773812066f8c46ea85b
```
...
=======
```{r FigCompare, echo = FALSE, fig.width=10}
...
In our case, ıpw doesn't come as an improvement in comparsion to the cc model. 
and usıng standard error
