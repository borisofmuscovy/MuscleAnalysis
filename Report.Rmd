...
Testing the population correlation: $H_0:correlation=0$; $H1:correlation \neq 0;$ $95\%CI$.
...
```{r figMissingHists, echo = FALSE, fig.width = 10, fig.height=7, fig.cap="\\label{fig:MissingHists}Histograms of the observed and missing data as well as marginplots depicting histograms and correlations."}
